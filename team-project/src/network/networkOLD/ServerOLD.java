...
public class ServerOLD{
	...
	public ServerOLD(int port, ServerListener listener){
							...
							Thread clientThread = new Thread(new Runnable(){
								public void run(){
									try{
										...
										ClientInst client = new ClientInst(s.getInetAddress(), s.getPort());
										serverListener.clientConnected(client, out);
										while(open){
											Application game = new Application (null);
											try{ serverListener.receivedInput(client, in.readLine());
											}catch(IOException e){
	...
	@SuppressWarnings("resource")public void kickClient(ClientInst client){
		Socket s;
